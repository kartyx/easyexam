...
public class PostActivity extends ActionBarActivity implements OnItemClickListener {

 String[] post_exam_name;
 TypedArray post_pic;
 ...
 protected void onCreate(Bundle savedInstanceState) {
  ...
  post_exam_name = getResources().getStringArray(R.array.Post);

  post_pic = getResources().obtainTypedArray(R.array.postimage);


  for (int i = 0; i < post_exam_name.length; i++) {
   RowItem item = new RowItem(post_exam_name[i],
     post_pic.getResourceId(i, -1));
   rowItems.add(item);
  }

  mylistview = (ListView) findViewById(R.id.postlist);
